...
exports.getTripById = exports.getTripsForUser = exports.getLatestTrips = exports.getAllTrips = exports.getTripCodeById = exports.createTripData = void 0;
...
const getLatestTrips = async (req, res) => {
    try {
        const { user_id } = req.params;
        if (!user_id || typeof user_id !== "string") {
            res.status(400).json({ error: "Missing or invalid user_id parameter" });
...
exports.getLatestTrips = getLatestTrips;
